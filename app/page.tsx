...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between lg:p-24">
      ...
      <div className="relative z-[-1] flex flex-col place-items-center before:absolute before:h-[200px] before:w-full before:-translate-x-1/3 before:rounded-full before:bg-gradient-radial before:from-red-500 before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-full after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-red-400 before:dark:opacity-15 before:opacity-15 after:dark:from-sky-700 after:dark:via-[#4b68dd] after:dark:opacity-40 sm:before:w-[380px] sm:after:w-[240px] before:lg:h-[300px]">
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 mb-4 opacity-40">
